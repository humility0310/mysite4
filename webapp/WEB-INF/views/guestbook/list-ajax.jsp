...
<script>
	...
	var render = function(vo, mode) {
		...
		var htmls = "<li id='gb-" + vo.no + "'>" + "<strong>" + vo.name
				+ "</strong>" + "<p>" + vo.content.replace(/\n/gi, "<br>")
				+ "</p>" + "<strong>" + vo.regDate + "</strong>"
		...
		$("#add-form")
				.submit(
						function(event) {
							...
							if (name == "") {
								messageBox("메세지 입력", "이름은 필수 입력 항목입니다.",
										function() {
											$("#input-name").focus();
										});
								return;
							...
							if (password == "") {
								messageBox("메세지 입력", "비밀번호는 필수 입력 항목입니다.",
										function() {
